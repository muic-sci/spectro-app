...
- **Reference light (calibration source)**: `Experiment.lightType` (`ReferenceLight`) chooses what supplies the known wavelengths for the pixel→λ fit. Two options:
